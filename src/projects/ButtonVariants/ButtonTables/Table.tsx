...
export function Table() {
  return (
    <div>
      <div className="hidden w-full items-center rounded-t-lg bg-[#1C162C] md:flex">
        <div className="h-16 w-[93px]"></div>
        ...
        <span className="ml-4 mr-[3px] w-[84px] text-center font-sans text-[11px] uppercase text-white">
          Cursor
        </span>
      </div>
      ...
      <div className="flex items-center gap-8 border-r-[6px] border-[#1C162C] bg-[#0b0911]">
        <div className="w-screen bg-[#1C162C] py-[32px] px-[10px] text-center font-sans text-[11px] uppercase leading-3 text-white md:w-[94px]">
          Default
        </div>
